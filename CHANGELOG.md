...
### Fixed
- *(cli)* filter unsupported files during ingest calculation ([#22](https://github.com/cartercanedy/rawbit/pull/22)) (by @cartercanedy)

### Miscellaneous
- *(CI)* lock down CI & repo ([#19](https://github.com/cartercanedy/rawbit/pull/19)) (by @cartercanedy)
